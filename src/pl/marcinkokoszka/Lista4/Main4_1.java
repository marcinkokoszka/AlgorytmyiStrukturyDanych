...
import pl.marcinkokoszka.Lista3.FIFOQueueDirectImplementation;
...
public class Main4_1 {
    ...
    public static void main(String[] args) {
        System.out.println("Utworzenie nowego stosu studentów o rozmiarze 5.\n");
        ArrayStack<Student> q = new ArrayStack<>(5);
